...
//Teemo
import Login from "./components/Teemo/";
import UserDashboard from "./components/Teemo/UserDashboard/";
import RoutePlan from "./components/Teemo/RoutePlan/";
import LandingPage from "./components/Teemo/LandingPage/";
import SyncPage from "./components/Teemo/SyncPage/";
import MyWebView from "./components/Teemo/MyWebView/";
import Gallery from "./components/Teemo/Gallery/";
...
const AppNavigator = StackNavigator(
    {
        ...
        Login: { screen: Login },
        UserDashboard: { screen: UserDashboard, path: 'UserDashboard/:id' },
        RoutePlan: { screen: RoutePlan },
        LandingPage: { screen: LandingPage },
        SyncPage: { screen: SyncPage},
